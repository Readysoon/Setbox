...
class TestSubjectControllersWithDatabase(flask_testing.TestCase):
    ...
    def setUp(self):
        ...
        with self.app.app_context():
            ...
            user9 = User(
                id=9, email="testy_email@setbox.de", first_name="Testy McTesty"
            )
            ...
            lesson2 = Lesson(
                ...
                subject_id=6,
                date=date(2023, 5, 11),
                start_time=time(14, 5, 5),
                end_time=time(16, 6, 4),
            )
    ...
    def test_create_subject(self):
        with self.app.app_context():
            ...
            subject = (
                Subject.query.filter(Subject.name == "Testyy Subjectyy")
                .filter(Subject.owner_user_id == 3)
                .first()
            )
    ...
    def test_find_subject_progress(self):
        with self.app.app_context():
            file1 = File(
                ...
                name="Test File 1",
                type="presentation",
                filename="1_20230507211447_test_file.pptx",
                lesson_id=1,
                reviewed=True,
            )
            file2 = File(
                ...
                name="Test File 2",
                type="presentation",
                filename="2_20230507230111_test_file_2.pptx",
                lesson_id=1,
                reviewed=False,
            )
